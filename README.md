...
* `to` - The path to handle as an Ember application. This will only apply to
  ...
  *Note:* If you specify a custom path, you must also update the `rootURL` in `frontend/config/environment.js`. See [Mounting multiple Ember applications][] for more information.
